...
<div class="row">
        ...
        <div class="border-dark row order-sm-last">
        ...
        <div class="mt-5 border-dark row">
            <div class="col-12 col-md-3 order-sm-last">
                <div class="card w-100">
        ...
        <div class="mt-5 border-dark row order-sm-last">
            <div class="col-12 col-md-3">
                <div class="card w-100">

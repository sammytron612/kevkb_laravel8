...
<h1><span class="text-primary fa fa-eye fa-1x mr-3"></span>View article<span><button type="button" class="pull-right btn btn-primary" data-toggle="modal" data-target="#modelId">
  Email
</button></span></h1>
@else
